...
$('.navbar').on('mousemove', function() { swing('.box') });

var one = document.getElementById('one');

$('#one').on('mousemove', function() { animate('.col-md-12') });

TweenMax.staggerFrom(".skill", 2, {scale:0.5, opacity:0, delay:0.5, ease:Elastic.easeOut, force3D:true}, 0.2);

//$(".col-md-12").click(function(){
//    TweenMax.staggerTo(".col-md-12", 0.5, {opacity:0, y:-100, ease:Back.easeIn}, 0.1);
//});
